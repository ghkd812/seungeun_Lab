...
| **전 직장** | ㈜지엠솔루션 LG CNS 협력사 · 책임연구원 BA (2022~2025) | MYSQL 주로 사용
| **전 직장** | 참좋은여행㈜ IT기획팀 · 계장 데이터분석&기획 (2017~2022) | MSSQL 주로 사용
...
| AM - PRODUCT쪽 ACCOUNT 매니져로써 MYSQL 데이터 분석 및 보정 작업 | INF 구조 설계 참여
...
| [고객 데이터 통계 분석](자사전체고객데이터분석및동향분석/) | MSSQL + 고객 기초통계·동향 분석 임원 리포팅 |
