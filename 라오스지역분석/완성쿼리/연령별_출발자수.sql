...
WITH LIST AS (
SELECT A.BIRTH_DATE,  COUNT(*) AS 출발자수
...
HAVING A.BIRTH_DATE <= '1998-01-01'
AND A.BIRTH_DATE > '1988-01-01'
--ORDER BY B.DEP_DATE
) 
SELECT YEAR(BIRTH_DATE), SUM(출발자수) AS CNT FROM LIST
GROUP BY YEAR(BIRTH_DATE) HAVING YEAR(BIRTH_DATE) > 1988 AND YEAR(BIRTH_DATE) <= 1998
